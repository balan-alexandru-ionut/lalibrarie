...
export const smoothies: Product[] = [
  new Product(
    'Bananǎ, fructe de pǎdure, lapte, miere',
    18,
    {
      minimum: 330,
      unit: 'ml'
...
export const sodas: Product[] = [
  ...
  new Product(
    'Apǎ mineralǎ Harghita',
    8,
    BOTTLE_QUANTITY
  ),
  new Product(
    'Apǎ platǎ Perla Harghitei',
    7,
    BOTTLE_QUANTITY
  ),
  new Product(
    'Ice Tea La Librǎrie, Mon Cher!',
    9,
    {
      minimum: 250,
      unit: 'ml'

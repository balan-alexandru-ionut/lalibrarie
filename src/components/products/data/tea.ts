...
import {
  ...
  APPLE_PIECES,
  BLACK_PEPPER,
  BLACK_TEA, BOURBON_VANILLA, CANDIED_STRAWBERRY_SLICES, CARAMEL,
  CARAWAY,
  CARDAMOM,
  CHAMOMILE,
  CHICORY_ROOTS,
  ...
  COCONUT_FLAKES,
  CORIANDER,
  DARK_CHOCOLATE, DEHYDRATED_STRAWBERRY,
  FERMENTED_TEA,
  FLAVORS,
  GINGER,
  GREEN_TEA,
  HAZELNUTS, JASMINE,
  JASMINE_BUDS, LEMON_FLAVOR, LEMON_GRASS, LEMON_PEEL,
  LUNG_CHING, LYCHEE, MALLOW, MANGO_FLAKES,
  MANGO_PIECES, MARIGOLD,
  ORANGE_PEEL,
  ORANGE_SLICES,
  PAI_MU_TAN, PAPAYA_PINEAPPLE_CUBES,
  PEPPERCORNS,
  PINEAPPLE_FLAKES, PINEAPPLE_PIECES,
  PINK_ROSE_BUDS,
  PISTACHIOS,
  RED_PEPPER,
  ROSE_BUDS, ROSE_PETALS, ROSES, SUGAR,
  SUGAR_CUBES,
  SUNFLOWER_BUDS, SUNFLOWER_INFLORESCENCE, SUNFLOWER_PETALS,
  VANILLA_COCOA, VANILLA_FLAVOR,
  VANILLA_PIECES,
  WHITE_CHOCOLATE, WHITE_TEA,
  YUNNAN
...
export const greenWhiteMixedTeas: Tea[] = [
  ...
  Tea.greenTea(
    ...
    16,
    TeaCategory.GreenWhiteMix,
  ).withIngredients(CHINA_SENCHA, LUNG_CHING, YUNNAN, PAI_MU_TAN, ROSE_BUDS, FLAVORS, ROSE_PETALS, MALLOW),
  Tea.greenTea(
    "Angel's Kiss",
    ...
    16,
    TeaCategory.GreenWhiteMix,
  ).withIngredients(GREEN_TEA, WHITE_TEA, PAPAYA_PINEAPPLE_CUBES, FLAVORS, ROSES, DEHYDRATED_STRAWBERRY),
  Tea.greenTea(
    "Spring Beginnings",
    ...
    16,
    TeaCategory.GreenWhiteMix,
  ).withIngredients(GREEN_TEA, CHINA_SENCHA, PAI_MU_TAN, FLAVORS, MANGO_FLAKES, ORANGE_SLICES, MARIGOLD, CANDIED_STRAWBERRY_SLICES),
]
...
export const greenTeas: Tea[] = [
  ...
  Tea.greenTea(
    ...
    13,
    TeaCategory.Green,
  ).withBrewTime(5).withIngredients(GREEN_TEA, CARAMEL, FLAVORS, "romanițǎ"),
  Tea.greenTea(
    "Sencha Lemon",
    ...
    13,
    TeaCategory.Green,
  ).withBrewTime(5).withIngredients(GREEN_TEA, LEMON_PEEL, LEMON_GRASS, LEMON_FLAVOR),
  Tea.greenTea(
    "Sencha Tropical",
    ...
    14,
    TeaCategory.Green,
  ).withIngredients(GREEN_TEA, PINEAPPLE_PIECES, SUGAR, MANGO_PIECES, SUNFLOWER_INFLORESCENCE, FLAVORS),
  Tea.greenTea(
    "Sencha Vanilla",
